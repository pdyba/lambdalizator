...
class TestRequestGeneral:
    def test___repr__(self, sample_request: Request) -> None:
...
class TestRequestRawBody:
    def test_raw_body_base64_bytes(self, sample_request: Request) -> None:
...
class TestRequestJsonBody:
    ...
    def test_json_body_base64_json(self, sample_request: Request) -> None:
        sample_request._is_base64_encoded = True  # pylint: disable=protected-access
    ...
    def test_json_body_bad_json(self, sample_request: Request) -> None:
        sample_request._json_body = None  # pylint: disable=protected-access
